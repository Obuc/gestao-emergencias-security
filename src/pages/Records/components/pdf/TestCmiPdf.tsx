...
import { TestCmiDataModal } from '../../types/TestCMI';
...
interface ITestCmiPdfProps {
  data: TestCmiDataModal;
}

export const TestCmiPdf = ({ data }: ITestCmiPdfProps) => {
      ...
      <Page size="A4" wrap style={styles.page}>
        ...
        <View style={styles.container}>
          <View style={styles.containerHeader}>
            <Text style={styles.containerTitle}>Informações Teste CMI</Text>
          </View>
