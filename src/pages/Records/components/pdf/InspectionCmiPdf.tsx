...
import { InspectionCmiDataModal } from '../../types/InspectionCMI';
...
interface IInspectionCmiPdfProps {
  data: InspectionCmiDataModal;
}

export const InspectionCmiPdf = ({ data }: IInspectionCmiPdfProps) => {
      ...
      <Page size="A4" wrap style={styles.page}>
        ...
        <View style={styles.container}>
          <View style={styles.containerHeader}>
            <Text style={styles.containerTitle}>Informações Inspeção CMI</Text>
          </View>
          <View style={styles.containerContent}>
            ...
            <View style={styles.containerContentItem}>
              ...
              <View style={[styles.containerItem, { width: '100%' }]}>
                ...
                <View style={styles.containerItemInput}>
                  <Text style={styles.containerItemTitle}>{data?.cmi?.site}</Text>
                </View>
              </View>
              ...
              <View style={[styles.containerItem, { width: '100%' }]}>
                ...
                <View style={styles.containerItemInput}>
                  <Text style={styles.containerItemTitle}>{data?.cmi?.predio}</Text>
                </View>
              </View>
            </View>
