...
export const GovernanceValvePdf = ({ data }: IGovernanceValvePdfProps) => {
      ...
      <Page size="A4" wrap style={styles.page}>
        ...
        <View style={styles.container}>
          <View style={styles.containerHeader}>
            <Text style={styles.containerTitle}>Informações Válvula de Governo</Text>
          </View>
          <View style={styles.containerContent}>
            ...
            <View style={styles.containerContentItem}>
              ...
              <View style={[styles.containerItem, { width: '100%' }]}>
                ...
                <View style={styles.containerItemInput}>
                  <Text style={styles.containerItemTitle}>{data?.valvula?.site}</Text>
                </View>
              </View>
              ...
              <View style={[styles.containerItem, { width: '100%' }]}>
                ...
                <View style={styles.containerItemInput}>
                  <Text style={styles.containerItemTitle}>{data?.valvula?.predio}</Text>
                </View>
              </View>
              ...
              <View style={[styles.containerItem, { width: '100%' }]}>
                ...
                <View style={styles.containerItemInput}>
                  <Text style={styles.containerItemTitle}>{data?.valvula?.pavimento}</Text>
                </View>
              </View>
            </View>
            ...
            <View style={styles.containerContentItem}>
              ...
              <View style={[styles.containerItem, { width: '100%' }]}>
                ...
                <View style={styles.containerItemInput}>
                  <Text style={styles.containerItemTitle}>{data?.valvula?.local}</Text>
                </View>
              </View>
            </View>
            ...
            <View style={styles.containerContentItem}>
              {/* Cód. Hidrante */}
              <View style={[styles.containerItem, { width: '100%' }]}>
                <Text style={styles.containerItemTitle}>Cód. Válvula</Text>
                <View style={styles.containerItemInput}>
                  <Text style={styles.containerItemTitle}>{data?.valvula?.cod_equipamento}</Text>
                </View>
              </View>
            </View>
