...
import { IGeneralChecklistModal } from '../../types/EmergencyVehicles/GeneralChecklist';
...
interface IGeneralChecklistPdfProps {
  data: IGeneralChecklistModal;
}

export const GeneralChecklistPdf = ({ data }: IGeneralChecklistPdfProps) => {
      ...
      <Page size="A4" wrap style={styles.page}>
        ...
        <View style={styles.container}>
          <View style={styles.containerHeader}>
            <Text style={styles.containerTitle}>Informações Checklist Geral</Text>
          </View>
        ...
        {data?.respostas &&
          Object.keys(data?.respostas).map((categoria) => {
            ...
            const numberOfGroups = Math.ceil(respostasCategoria.length / 5);
