...
import useGovernanceValveBXO from './hooks/useGovernanceValveBXO';
import GovernanceValveTableBXO from './components/GovernanceValveTableBXO';
import GovernanceValveFiltersBXO from './components/GovernanceValveFiltersBXO';

const GovernanceValveBXO = () => {
...
export default GovernanceValveBXO;
