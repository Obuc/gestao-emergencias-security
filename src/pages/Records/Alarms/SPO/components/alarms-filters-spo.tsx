...
interface IFilters {
  tempTableFilters: AlarmsFilters;
  setTempTableFilters: React.Dispatch<React.SetStateAction<AlarmsFilters>>;
  handleRemoveAllFilters: () => void;
  countAppliedFilters: () => number;
  handleApplyFilters: () => void;
}

const AlarmsFiltersSPO = ({
  tempTableFilters,
  setTempTableFilters,
...
export default AlarmsFiltersSPO;
