...
interface IFilters {
  tempTableFilters: DeaFilters;
  setTempTableFilters: React.Dispatch<React.SetStateAction<DeaFilters>>;
      ...
      <Popover.Content>
        ...
        <div className="flex flex-col gap-2 py-6">
          ...
          <TextField
            ...
            id="cod"
            name="cod"
            value={tempTableFilters.cod || ''}
            onChange={(event) => {
              setTempTableFilters((prev) => ({ ...prev, cod: event.target.value }));
            }}
          />
