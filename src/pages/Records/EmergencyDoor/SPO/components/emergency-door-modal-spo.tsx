...
import { EmergencyDoorPdfSPO } from './emergency-door-pdf-spo';
import useEmergencyDoorModalSPO from '../hooks/emergency-door-modal-spo.hook';

const EmergencyDoorModalSPO = () => {
...
export default EmergencyDoorModalSPO;
