...
interface IFilters {
  tempTableFilters: EmergencyDoorFilters;
  setTempTableFilters: React.Dispatch<React.SetStateAction<EmergencyDoorFilters>>;
  handleRemoveAllFilters: () => void;
  countAppliedFilters: () => number;
  handleApplyFilters: () => void;
}

const EmergencyDoorFiltersSPO = ({
  tempTableFilters,
  setTempTableFilters,
...
export default EmergencyDoorFiltersSPO;
