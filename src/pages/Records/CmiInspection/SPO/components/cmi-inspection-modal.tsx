...
import { InspectionCmiPdfSPO } from './cmi-inspection-pdf';
import { useInspectionCmiModalSPO } from '../hooks/cmi-inspection.hook';

export const InspectionCmiModalSPO = () => {
  ...
  const handleOnOpenChange = () => {
    ...
    navigate('/spo/records/cmi_inspection');
  };
