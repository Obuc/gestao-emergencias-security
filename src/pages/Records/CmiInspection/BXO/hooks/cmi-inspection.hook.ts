...
import { IInspectionCMIFiltersProps } from '../types/cmi-inspection.types';

export const useInspectionCmiBXO = () => {
  ...
  const inspectionCmi = useInfiniteQuery({
    ...
    staleTime: 1000 * 60,
    enabled: pathname.includes('/bxo/records/cmi_inspection') && user_site === 'BXO',
  });
