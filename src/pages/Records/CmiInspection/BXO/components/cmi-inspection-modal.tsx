...
import { InspectionCmiPdfBXO } from './cmi-inspection-pdf';
import { ResponstaInspectionCMI } from '../types/cmi-inspection.types';
import { useInspectionCmiModalBXO } from '../hooks/cmi-inspection-modal.hook';

export const InspectionCmiModalBXO = () => {
