...
import { TestCmiCmiPdfBXO } from './cmitest-pdf';
import { ResponstaTestCmi } from '../types/cmitest.types';
import { useTestCmiModalBXO } from '../hooks/cmitest-modal.hook';

export const TestCmiModalBXO = () => {
