...
import { InspectionCMI } from '../types/InspectionCmiBXO';
import InspectionCmiModalBXO from './InspectionCmiModalBXO';
...
const InspectionCmiTableBXO = ({ inspectionCmi, mutateRemove, setSortColumns, sortColumns }: ITableProps) => {
...
export default InspectionCmiTableBXO;
