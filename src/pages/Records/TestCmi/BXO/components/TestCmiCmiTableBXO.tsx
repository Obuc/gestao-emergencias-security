...
import { TestCMI } from '../types/TestCmiBXO';
import TestCmiModalBXO from './TestCmiModalBXO';
...
const TestCmiCmiTableBXO = ({ testCmi, mutateRemove, setSortColumns, sortColumns }: ITableProps) => {
...
export default TestCmiCmiTableBXO;
