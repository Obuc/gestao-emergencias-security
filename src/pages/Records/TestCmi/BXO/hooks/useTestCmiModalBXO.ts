...
import { ResponstaTestCmi, TestCmiDataModal } from '../types/TestCmiBXO';
import { sharepointContext } from '../../../../../context/sharepointContext';

const useTestCmiModalBXO = () => {
  ...
  const testCmiModal = useQuery({
    ...
    enabled: params.id !== undefined && pathname === `/records/cmi_test/${params.id}` && user_site === 'BXO',
  });
...
export default useTestCmiModalBXO;
