...
import { HydrantPdfBXO } from './hydrant-pdf';
import { Answers } from '@/components/Answers';
import TextField from '@/components/TextField';
import { RespostaHydrants } from '../types/hydrant.types';
import { useHydrantModalBXO } from '../hooks/hydrant-modal.hook';

export const HydrantModalBXO = () => {
