...
import { Hydrants } from '../types/HydrantBXO';
import HydrantModalBXO from './HydrantModalBXO';
...
const HydrantTableBXO = ({ hydrant, mutateRemove, setSortColumns, sortColumns }: IHydrantTableProps) => {
...
export default HydrantTableBXO;
