...
import { IHydrantsFiltersProps } from '../types/hydrant.types';
import { SelectAutoComplete } from '@/components/SelectAutocomplete';

interface IHydrantFilters {
  tempTableFilters: IHydrantsFiltersProps;
  setTempTableFilters: React.Dispatch<React.SetStateAction<IHydrantsFiltersProps>>;
  handleRemoveAllFilters: () => void;
  countAppliedFilters: () => number;
  handleApplyFilters: () => void;
}

export const HydrantFiltersBXO = ({
  tempTableFilters,
  setTempTableFilters,
      ...
      <Popover.Content>
        ...
        <div className="flex flex-col gap-2 py-6">
          ...
          <TextField
            ...
            id="codHydrant"
            name="codHydrant"
            value={tempTableFilters.codHydrant || ''}
            onChange={(event) => {
              setTempTableFilters((prev) => ({ ...prev, codHydrant: event.target.value }));
            }}
          />
