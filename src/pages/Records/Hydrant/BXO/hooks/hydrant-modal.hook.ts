...
import { HydrantsDataModal, RespostaHydrants } from '../types/hydrant.types';

export const useHydrantModalBXO = () => {
  ...
  const hydrantModal = useQuery({
    ...
    enabled: params.id !== undefined && pathname === `/bxo/records/hydrant/${params.id}` && user_site === 'BXO',
  });
