...
import { ExtinguisherModalSPO } from './extinguisher-modal';
...
export const ExtinguisherTableSPO = ({
  extinguisher,
  mutateRemove,
  setSortColumns,
  sortColumns,
  ...
  const handleView = (Id: number) => {
    navigate(`/spo/records/extinguisher/${Id}?edit=false`);
  };

  const handleEdit = (Id: number) => {
    navigate(`/spo/records/extinguisher/${Id}?edit=true`);
  };
