...
import { EyewashShowerTableSPO } from './components/eyewash-shower-table';
import { EyewashShowerFiltersSPO } from './components/eyewash-shower-filters';

export const EyewashShowerSPO = () => {
      ...
      <LayoutBase showMenu>
        <div className="flex flex-col h-full w-full justify-between bg-[#F1F1F1]">
          <div className="flex h-full flex-col p-8">
            ...
            <EyewashShowerTableSPO
              eyewashShower={eyewashShower}
