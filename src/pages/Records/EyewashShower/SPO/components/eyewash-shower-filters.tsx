...
interface IFilters {
  tempTableFilters: IEyewashShowerFiltersProps;
  setTempTableFilters: React.Dispatch<React.SetStateAction<IEyewashShowerFiltersProps>>;
  handleRemoveAllFilters: () => void;
  countAppliedFilters: () => number;
  handleApplyFilters: () => void;
}

export const EyewashShowerFiltersSPO = ({
  tempTableFilters,
  setTempTableFilters,
