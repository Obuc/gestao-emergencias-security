...
import { AmbulanceCheckPdfSPO } from './ambulance-check-pdf-spo';
import useAmbulanceCheckModalSPO from '../hooks/ambulance-check-modal-spo.hook';

const AmbulanceCheckModalSPO = () => {
...
export default AmbulanceCheckModalSPO;
