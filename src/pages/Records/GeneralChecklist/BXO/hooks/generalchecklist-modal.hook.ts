...
import { IGeneralChecklistModal, IRespostaGeneralChecklist } from '../types/generalchecklist.types';

export const useGeneralChecklistModalBXO = () => {
  ...
  const generalChecklistModal = useQuery({
    ...
    enabled: params.id !== undefined && pathname.includes('/bxo/records/general_checklist'),
  });
  ...
  const mutateEdit = useMutation({
    ...
    onSuccess: () => {
      ...
      const timeoutId = setTimeout(() => {
        ...
        navigate(`/bxo/records/general_checklist`);
