...
import { IGeneralChecklist } from '../types/GeneralChecklistBXO';
import GeneralChecklistModalBXO from './GeneralChecklistModalBXO';
...
const GeneralChecklistTableBXO = ({ generalChecklist, mutateRemove, setSortColumns, sortColumns }: ITableProps) => {
...
export default GeneralChecklistTableBXO;
