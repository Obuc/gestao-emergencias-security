...
import { GeneralChecklistPdfBXO } from './generalchecklist-pdf';
import { IRespostaGeneralChecklist } from '../types/generalchecklist.types';
import { useGeneralChecklistModalBXO } from '../hooks/generalchecklist-modal.hook';

export const GeneralChecklistModalBXO = () => {
