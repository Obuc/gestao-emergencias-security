...
interface IFilters {
  tempTableFilters: IGeneralChecklistFiltersProps;
  setTempTableFilters: React.Dispatch<React.SetStateAction<IGeneralChecklistFiltersProps>>;
  handleRemoveAllFilters: () => void;
  countAppliedFilters: () => number;
  handleApplyFilters: () => void;
}

const GeneralChecklistFiltersBXO = ({
  tempTableFilters,
  setTempTableFilters,
...
export default GeneralChecklistFiltersBXO;
