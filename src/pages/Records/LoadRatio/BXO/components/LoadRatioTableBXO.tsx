...
import { ILoadRatio } from '../types/LoadRatioBXO';
import LoadRatioModalBXO from './LoadRatioModalBXO';
...
const LoadRatioTableBXO = ({ loadRatio, mutateRemove, setSortColumns, sortColumns }: ITableProps) => {
...
export default LoadRatioTableBXO;
