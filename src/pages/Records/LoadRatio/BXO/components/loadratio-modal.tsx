...
import { LoadRatioPdfBXO } from './loadratio-pdf';
import { IRespostaLoadRatio } from '../types/loadratio.types';
import { useLoadRatioModalBXO } from '../hooks/loadratio-modal.hook';

export const LoadRatioModalBXO = () => {
