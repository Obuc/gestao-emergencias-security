...
import { OeiFiltersProps } from '../types/oei.types';
import { SelectAutoComplete } from '@/components/SelectAutocomplete';

interface IFilters {
  tempTableFilters: OeiFiltersProps;
  setTempTableFilters: React.Dispatch<React.SetStateAction<OeiFiltersProps>>;
  handleRemoveAllFilters: () => void;
  countAppliedFilters: () => number;
  handleApplyFilters: () => void;
}

export const OeiFilters = ({
  tempTableFilters,
  setTempTableFilters,
