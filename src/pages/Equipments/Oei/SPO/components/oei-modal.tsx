...
export const OeiModal = () => {
  ...
  const { oeiModalData, historyModalData, setYear, year } = useOeiModal();
  ...
  const handleOnOpenChange = () => {
    setValveItem(null);
    navigate('/spo/equipments/oei_operation');
  };
            ...
            historyModalData.data.map((item) => {
              ...
              return (
                <EquipmentCard.Root key={item.Id} variant={cardVariant}>
                  <EquipmentCard.Header title={cardTitle} link={`/spo/records/oei_operation/${item.idRegistro}`} />
