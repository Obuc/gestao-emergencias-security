...
import { useOei } from './hooks/oei.hook';
import LayoutBase from '@/layout/LayoutBase';
import { Button } from '@/components/Button';
import { OeiTable } from './components/oei-table';
import { OeiFilters } from './components/oei-filters';
import { OeiQrcodeModal } from './components/oei-qrcode-modal';

const EquipmentsOeiSPO = () => {
    ...
    <>
      <LayoutBase showMenu>
        ...
        {openModalGenerateQRCode && (
          <OeiQrcodeModal open={openModalGenerateQRCode} onOpenChange={() => setOpenModalGenerateQRCode(null)} />
        )}
      </LayoutBase>
...
export default EquipmentsOeiSPO;
