...
export const LoadRatioQrcodePdf = ({ data, pageSize }: { data: Array<LoadRatioProps>; pageSize: StandardPageSize }) => {
        ...
        {data.map((value) => (
          <View style={stylesQRCode.container} key={value.Id} wrap={false}>
            ...
            <View style={stylesQRCode.containerQrCode}>
              ...
              >{`RelacaoCarga/${value?.site}/${value?.cod_qrcode}/${value?.tipo_veiculo}`}</Text>
