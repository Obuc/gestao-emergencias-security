...
export const AmbulanceCheckModal = () => {
  ...
  const { ambulanceCheckModalData } = useAmbulanceCheckModal();
    ...
    >
      <>
        ...
        <div className="py-4 px-8">
          {!ambulanceCheckModalData.data?.history?.length && !ambulanceCheckModalData.isLoading && <CardEmpy />}
          {ambulanceCheckModalData.isLoading && <CardSkeleton />}

          {ambulanceCheckModalData.data?.history &&
            ambulanceCheckModalData.data?.history.map((item) => {
