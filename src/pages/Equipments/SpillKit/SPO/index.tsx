...
import { SpillKitTable } from './components/spill-kit-table';
import { SpillKitFilters } from './components/spill-kit-filters';
import { SpillKitQrcodeModal } from './components/spill-kit-qrcode-modal';

const EquipmentsSpillKitSPO = () => {
    ...
    <>
      <LayoutBase showMenu>
        ...
        {openModalGenerateQRCode && (
          <SpillKitQrcodeModal open={openModalGenerateQRCode} onOpenChange={() => setOpenModalGenerateQRCode(null)} />
        )}
      </LayoutBase>
...
export default EquipmentsSpillKitSPO;
