...
interface IEqHydrantsQRCodePdfProps {
  data: Array<any>;
}

export const EqHydrantsQRCodePdf = ({ data }: IEqHydrantsQRCodePdfProps) => {
        ...
        {data.map((value) => (
          <View style={styles.container} key={value.Id} wrap={false}>
            ...
            <View style={styles.containerQrCode}>
              ...
              <Text style={styles.footerTitle}>{`Hidrante/${value?.site}/${value?.predio}/${value?.pavimento}`}</Text>
