...
import { HydrantsFiltersProps } from '../types/hydrants.types';
import { SelectAutoComplete } from '@/components/SelectAutocomplete';

interface IFilters {
  tempTableFilters: HydrantsFiltersProps;
  setTempTableFilters: React.Dispatch<React.SetStateAction<HydrantsFiltersProps>>;
  handleRemoveAllFilters: () => void;
  countAppliedFilters: () => number;
  handleApplyFilters: () => void;
}

const HydrantFilters = ({
  tempTableFilters,
  setTempTableFilters,
      ...
      <Popover.Content>
        ...
        <div className="flex flex-col gap-2 py-6">
          ...
          <TextField
            ...
            value={tempTableFilters.numero_hidrante || ''}
            onChange={(event) => {
              setTempTableFilters((prev) => ({ ...prev, numero_hidrante: event.target.value }));
            }}
          />
