...
import { EmergencyDoorsFiltersProps } from '../types/emergencydoors.types';

interface IFilters {
  tempTableFilters: EmergencyDoorsFiltersProps;
  setTempTableFilters: React.Dispatch<React.SetStateAction<EmergencyDoorsFiltersProps>>;
  handleRemoveAllFilters: () => void;
  countAppliedFilters: () => number;
  handleApplyFilters: () => void;
}

export const EmergencyDoorsFilters = ({
  tempTableFilters,
  setTempTableFilters,
