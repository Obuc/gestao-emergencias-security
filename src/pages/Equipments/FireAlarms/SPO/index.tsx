...
import { useFireAlarms } from './hooks/firealarms.hook';
import { FireAlarmsTable } from './components/firealarms-table';
import { FireAlarmsFilters } from './components/firealarms-filters';
import { FireAlarmsQrcodeModal } from './components/firealarms-qrcode-modal';

const EquipmentsFireAlarmsSPO = () => {
    ...
    <>
      <LayoutBase showMenu>
        ...
        {openModalGenerateQRCode && (
          <FireAlarmsQrcodeModal open={openModalGenerateQRCode} onOpenChange={() => setOpenModalGenerateQRCode(null)} />
        )}
      </LayoutBase>
...
export default EquipmentsFireAlarmsSPO;
