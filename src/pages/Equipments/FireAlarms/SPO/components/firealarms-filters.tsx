...
import { FireAlarmsFiltersProps } from '../types/firealarms.types';
import { SelectAutoComplete } from '@/components/SelectAutocomplete';

interface IFilters {
  tempTableFilters: FireAlarmsFiltersProps;
  setTempTableFilters: React.Dispatch<React.SetStateAction<FireAlarmsFiltersProps>>;
  handleRemoveAllFilters: () => void;
  countAppliedFilters: () => number;
  handleApplyFilters: () => void;
}

export const FireAlarmsFilters = ({
  tempTableFilters,
  setTempTableFilters,
