...
import { EyewashShowerFiltersProps } from '../types/eyewash-shower.types';

interface IFilters {
  tempTableFilters: EyewashShowerFiltersProps;
  setTempTableFilters: React.Dispatch<React.SetStateAction<EyewashShowerFiltersProps>>;
  handleRemoveAllFilters: () => void;
  countAppliedFilters: () => number;
  handleApplyFilters: () => void;
}

export const EyewashShowerFilters = ({
  tempTableFilters,
  setTempTableFilters,
